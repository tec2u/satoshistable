<?php
	...
	echo "ok---TYPE:".$_GET['type']."---IDPEDIDO:".$_GET['idpedido'];


	 if($_GET['type']=="Bonificacao" and $_GET['idpedido']>0){
		
		$order_id=$_GET['idpedido'];
	   ...
	   if($_GET['type']=="CadastroBinario" and $_GET['user_id']>0){
		
		$id_comprador=$_GET['user_id'];
	   ...
	   if($_GET['type']=="CompensacaoBinaria"){
