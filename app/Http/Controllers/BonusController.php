...
class BonusController extends Controller
{
    ...
    /**
     * Sobe a Bonificação na rede.
     *
     * @param  int  $contador controla a contagem
     * @param  int  $indicador recommendation_user_id
     * @param  int  $package_valor price
     * @param  array  $lista id_user 
     * @return \Illuminate\Http\Response
     */

    function bonus_compra($contador,$indicador,$package_valor,array $lista = array())
    {
        if($contador < 16)
        {   
