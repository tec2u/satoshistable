...
class WithdrawController extends Controller
{
   ...
   public function withdrawRequests()
   {
      ...
      $lastWallet = Wallet::where('user_id', $id_user)->latest()->first();

      return view('withdraw.withdrawrequest', compact('withdraws', 'user', 'lastWallet'));
   }
   ...
   public function store(Request $request)
   {
      ...
      $wallet = Wallet::where('user_id', $id_user)->latest()->first();
