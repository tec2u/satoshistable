...
<div class="card">
   <div class="card-header">
      ...
      <h3>@lang('admin.registration.registrations_by_country_report')</h3>
      <h5>@lang('admin.registration.registrations_by_country')</h5>
      </div>
   </div>
   <div class="card-body table-responsive">
      ...
      <table class="table table-hover table-bordered results">
         <thead>
            <tr>
            <th>@lang('admin.registration.country')</th>
