...
<div class="col-lg-6">
    <div class="card card-primary">
        ...
        <form action="{{route('admin.configBonus.store')}}" method="POST" enctype="multipart/form-data">
            <div class="card-body">
                @csrf
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input
                                ...
                                name="user_activated"
                                placeholder="1"
                                value="{{old('user_activated')}}" disabled>
