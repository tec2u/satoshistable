            ...
            <div class="btn-group">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item"
                  href="{{ route('admin.users.filter', ['parameter' => 'activated']) }}">@lang('admin.members.filterUser.active')</a>
                <a class="dropdown-item"
                  href="{{ route('admin.users.filter', ['parameter' => 'desactivated']) }}">@lang('admin.members.filterUser.desactive')</a>
              </div>
            </div>
          </div>
        </div>
