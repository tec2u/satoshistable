          ...
          <form action="{{ route('admin.packages.search') }}" method="POST">
            ...
            <div class="input-group input-group-lg">
              <input type="text" name="search" class="form-control @error('search') is-invalid @enderror"
                placeholder="@lang('admin.package.search')">
            ...
            <div class="btn-group">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item"
                  href="{{ route('admin.packages.filter', ['parameter' => 'activated']) }}">@lang('admin.package.filterPackage.active')</a>
                <a class="dropdown-item"
                  href="{{ route('admin.packages.filter', ['parameter' => 'desactivated']) }}">@lang('admin.package.filterPackage.desactive')</a>
              </div>
            </div>
          </div>
        </div>
                ...
                <div class="row justify-content-between">
                  <div class="text-right">
                    <form action="{{ route('admin.packages.delete', ['id' => $package->id]) }}" method="post">
                      <a href="{{ route('admin.packages.edit', ['id' => $package->id]) }}" class="btn bg-teal"
