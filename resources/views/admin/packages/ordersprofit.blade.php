...
@section('content_header')
  <h4>@lang('admin.orders.orders.profit_orders')</h4>
@stop
  ...
  <div class="card">
    <div class="card-header">
      <div class="alignPackage">
        <h3>@lang('admin.orders.orders.profit_orders')</h3>
      </div>
    </div>
    <div class="card-header">
      <div class="row">
      ...
      <table class="table table-hover table-bordered results">
        <thead>
          <tr>
            ...
            <th>@lang('admin.orders.orders.link')</th>
            <td></td>
          </tr>
             ...
             <th>{{ $orderpackage->login}}</th>
              ...
              <td>
                @if ($orderpackage->status == 2)
                  <button class="btn btn-danger btn-sm m-0">@lang('admin.orders.orders.canceled')</button>
                @elseif($orderpackage->status == 1)
                  <button class="btn btn-success btn-sm m-0">@lang('admin.orders.orders.paid')</button>
                @else
