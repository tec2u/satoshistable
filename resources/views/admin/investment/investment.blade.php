      ...
      <table class="table table-hover table-bordered results">
         <thead>
            ...
            <tr class="warning no-result">
               <td colspan="4"><i class="fa fa-warning"></i> @lang('admin.investment.table.no_result')</td>
            </tr>
         </thead>
         <tbody>
         @forelse($investments as $investment)
            <tr>
               ...
               @case(0)
               <td><button class="btn btn-primary btn-sm m-0">@lang('admin.investment.table.waiting_payment')</button></td>
               @break
               @case(1)
               <td><button class="btn btn-primary btn-sm m-0">@lang('admin.investment.table.active')</button></td>
               @break
               @default
               <td><button class="btn btn-danger btn-sm m-0">@lang('admin.investment.table.cancelled')</button></td>
               @endswitch
