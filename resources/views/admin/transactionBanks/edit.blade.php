  ...
  <div class="row d-flex justify-content-center ">
    <div class="col-lg-6">
      <div class="card card-primary">
        ...
        <form action="{{ route('admin.banks.update', ['id' => $bank->id]) }}" method="POST"
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="name" class="form-control form-control-lg @error('name') is-invalid @enderror"
                id="name" name="name" placeholder="@lang('admin.editPackage.edit.entername')" value="{{ $bank->name }}">
              @error('name')
              ...
              <div class="col md 6">
                <div class="form-group">
                  ...
                  <select class="form-control form-control-lg @error('password') is-invalid @enderror" name="activated"
                    id="activated">
                    <option value="1" @if ($bank->activated == 1) selected @endif>
                      @lang('admin.editPackage.edit.activetype.activated')</option>
                    <option value="0" @if ($bank->activated == 0) selected @endif>
