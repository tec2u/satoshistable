            ...
            <div class="col-12">
              ...
              <div class="card shadow my-3">
                ...
                <form class="row g-3 p-5" action="{{ route('users.update', ['id' => $user->id]) }}" method="POST"
                  ...
                  <div class="col-md-6">
                    <label for="inputname" class="form-label">@lang('user.birthday')<span style="color: brown">*</span></label>
                    <input type="date" class="form-control" id="birthday" required name="birthday"
                      value="{{ $user->birthday }}">
                  </div>
                  <div class="col-md-6">
                    <label for="inputname" class="form-label">@lang('user.city')<span style="color: brown">*</span></label>
                  ...
                  <div class="col-md-6">
                    ...
                    <select class="form-control" id="country" required name="country" tabindex="7">
                      <option>@lang('user.select_country')</option>
                  ...
                  <div class="col-md-12 row">
                    ...
                    <div class="col-md-4">
                      <label for="inputemail" class="form-label">@lang('user.username')<span
                          style="color: brown">*</span></label>
                      <input type="email" class="form-control" id="email" readonly name="text"
                        value="{{ $user->login ?? '' }}">
                    </div>
                  </div>
                  <div class="col-md-6">
                  ...
                  {{--  --}}
                  <div class="col-md-12">
                    <label for="walltet" class="form-label">@lang('user.wallet_usdt_trc20')</label>
                    <input type="text" class="form-control" id="wallet" name="wallet"
                      value="{{ empty($user->wallet) ? '' : $user->wallet }}">
                  </div>
                  {{-- <div class="col-md-6">
                  ...
                  <div class="col-md-4">
                    <span onclick="authChange()" class="btn btn-primary rounded-pill mb-3 up font"
                      id="change_bt">@lang('user.save')</span>
                    ...
                    <div class="col-md-12">
                      <button type="submit" class="btn btn-primary rounded-pill mb-3 up font" id="confirm_password"
                        style="display: none">@lang('user.confirm')</button>
                    </div>
                  </div>
                </form>
              </div>
