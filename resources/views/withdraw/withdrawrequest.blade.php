        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body my-3">
              ...
              <div class="amount">Your Wallet: <b>{{ $lastWallet->wallet ?? '' }}</b>
              </div>
              <form action="{{ route('withdraws.store') }}" method="POST">
                ...
                <div class="modal-footer" style="display: flex;display:flex;justify-content: space-between">
                  <div style="display: flex;display:flex;flex-direction: column">
                    <div>
                      <input type="checkbox" name="confirmWallet" id="" required> Confirm wallet?</input>
                    </div>

                    <a href="{{ route('users.index') }}" style="color: blue">Edit wallet</a>
                  </div>
                  <div class="d-flex">
