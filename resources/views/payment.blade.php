        ...
        <section id="payment" class="content">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12">
                        <h1>@lang('user.payment')</h1>
                        <div class="card shadow my-3">
                            <h3 style="margin-left: 2%;" class="card-title">@lang('user.value')</h3>
                            ...
                            <div class="row p-3 mt-4 teste000">
                                ...
                                <div class="info-box mb-4 shadow">
                                    <div class="info-box-content">
                                        <span class="info-box-text">@lang('user.btc'): {{$paymentInfo['BTC']}}</span>
                        ...
                        <div class="info-box mb-4 shadow">
                            <div class="info-box-content">
                                <span class="info-box-text">@lang('user.eur'): {{$paymentInfo['EUR']}}</span>
                <img src='https://chart.googleapis.com/chart?chs=250x250&cht=qr&chl=eur:{{$paymentInfo['address']}}?amount={{$paymentInfo['EUR']}}' />
                                ...
                                <h3 class="fw-bold">@lang('user.wallet'): </h3>
                                    <input type="text" class="form-control" id="AddressInput"
                                                    value="{{ $paymentInfo['address'] }}">
                                                <button class=" btn btn-dark orderbtn linkcopy px-4" type="button"
                                                    onclick="CopyAddress()">@lang('user.copy_address')</button>
