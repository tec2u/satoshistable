          ...
          <div
            ...
            <div class="text-center" style="margin: 0 auto;margin-top: 151px;">
              ...
              <div class="mt-3" style="color:white">
                ...
                <h3 class=" hheroland fw-bold">STEP 3 - UPLOADING MT4 SERVER INFO</h3>
                <p class=" pheroland ">SINCE YOU CREATED YOUR ACCOUNT, YOU RECEIVED AN EMAIL WITH LOGIN NUMBER, LOGIN
                  PASSWORD, SERVER ADDRESS. FILL IN THE INFO BELOW: </h3>
                  </br></br></br>
                <form action="{{ route('step.post.4') }}" method="post" enctype="multipart/form-data">
                  @csrf
                  <input type="hidden" name="id_package" value="{{ $data['id_package'] }}">
                  LOGIN NUMBER: <input type='text' name='login_number' placeholder='LOGIN NUMBER' required>
                  LOGIN PASSWORD: <input type='text' name='login_password' placeholder='LOGIN PASSWORD' required>
                  SERVER ADDRESS: <input type='text' name='server_address' placeholder='SERVER ADDRESS' required>
                  UPLOAD PRINTSCREEN<input type='file' name='upload_print' accept="image/*"
                    placeholder='UPLOAD PRINTSCREEN' required>
                  <button class="btn btn-warning ms-md-2 btnnav" type="submit">UPLOAD AND GO TO STEP
                    4</button>
                </form>
                {{-- <a href="/create_new_bot_step4"><button class="btn btn-warning ms-md-2 btnnav"></button></a> --}}
