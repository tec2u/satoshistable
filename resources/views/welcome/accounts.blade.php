      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 text-center hoveraccountcard">
            <div class="my-4">
              <i class="la la-check text-dark iconv mt-2" data-aos="fade" data-aos-duration="800" data-aos-delay="200"
          ...
          <div class="col-md-6 col-lg-3 text-center hoveraccountcard">
            <div class="my-4">
              <i class="la la-check text-dark iconv mt-2" data-aos="fade" data-aos-duration="800"
                data-aos-delay="200" data-aos-once="true"></i>
          ...
          <div class="col-md-6 py-5" style="text-align: center; min-height: 400px">
            <div class="d-flex align-items-center divimg">
              <img class="img-fluid" data-aos="fade-right" data-aos-duration="1800" data-aos-once="true"
                src="assetsWelcome/images/iphonenolimit.png?h=08c15e065881663849a83ac168725197" width="600px"
                style="margin: auto" />
            </div>
          </div>
          ...
          <div class="col-md-6 order-md-last py-5" style="text-align: center; min-height: 400px">
            <div class="d-flex align-items-center divimg">
              <img class="img-fluid" data-aos="fade-left" data-aos-duration="1800" data-aos-once="true"
                src="assetsWelcome/images/mac_on_table2.png?h=b85a817873aa0be3ac4efe149a0e9ca4" style="margin: auto"
                width="600px" />
            </div>
          </div>
          <div class="col-md-6 columncardr py-5">
